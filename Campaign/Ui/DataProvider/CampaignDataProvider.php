...
namespace Impact\Campaign\Ui\DataProvider;

use Impact\Campaign\Api\Data\CampaignInterface;
use Impact\Campaign\Query\Campaign\GetListQuery;
 ...
 */
class CampaignDataProvider extends DataProvider
{
    /**
     * @var GetListQuery
     */
...
//            $item['products'] = explode(',', $item['products'] ?? []);
            $itemsById[(int)$item[CampaignInterface::CAMPAIGN_ID]] = $item;
        }

        if ($id = $this->request->getParam(CampaignInterface::CAMPAIGN_ID)) {
