...
namespace Impact\Campaign\Ui\Component\Listing\Column;
 ...
 */
class CampaignBlockActions extends Column
{
    /**
     * Entity name.
     */
     ...
     * Url paths.
     */
    private const EDIT_URL_PATH = 'campaign/campaign/edit';
    private const DELETE_URL_PATH = 'campaign/campaign/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[CampaignInterface::CAMPAIGN_ID])) {
                    ...
                    $urlData = [CampaignInterface::CAMPAIGN_ID => $item[CampaignInterface::CAMPAIGN_ID]];
